...
- [Download Link](https://github.com/Richasy/ReaderCopilot.Public/releases)

:::tip

The source is based on .NET 7, please make sure you have the relevant runtime environment installed on your device before using it.

You can download the SDK or Runtime for your platform in [Download .NET 7.0] (https://dotnet.microsoft.com/en-us/download/dotnet/7.0).
