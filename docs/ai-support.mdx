...
:::tip
Before connecting Fantasy Copilot, you must make sure that you already install the [.NET SDK](https://dotnet.microsoft.com/en-us/download/dotnet/7.0) on your device.
:::
